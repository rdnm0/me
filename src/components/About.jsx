    ...
    return (
        ...
        >
            ...
            Hi, I'm Rohan, a passionate software developer based in Toronto. I'm currently studying in the International Baccalaureate Diploma Programme (IBDP) in 11th grade. In my free time, I enjoy hitting the gym to stay fit and watching anime to unwind. For the past two years, I've been honing my coding skills, particularly focusing on competitive programming. I have a strong background in web development, where I enjoy creating user-friendly solutions that empower people to achieve their goals.
